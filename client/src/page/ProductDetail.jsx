...
import ProductReviews from '../component/Card/ProductReviews'
...
const ProductDetail = () => {
  ...
  useEffect(() => {
    ...
    const fetchReviews = async () => {
      try {
        const response = await axios.get(`/reviews/customer/${product?._id}`)
  ...
  useEffect(() => {
    ...
    const fetchRatings = async () => {
      try {
        const response = await axios.get(`/reviews/rating/detail/${product?._id}`)
